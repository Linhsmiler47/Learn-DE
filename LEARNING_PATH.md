...
| 2 | 02 — Git and GitHub | **In Progress** | Full detailed learning module built (`lessons/`, `exercises/`, `assessment/`, etc.) on 2026-07-12, using the real `Learn-DE` repository throughout per the Repository Usage Policy. Assessment not yet attempted. |
...
| 3 | 04 — Configuration and Application Structure | **Planned** | Syllabus only |
